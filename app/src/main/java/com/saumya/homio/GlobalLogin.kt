...
import com.saumya.homio.student.StudentLogin
import com.saumya.homio.warden.WardenLogin
...
class GlobalLogin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shareRepo.setOnClickListener(){
            val url = "https://github.com/saumyaoj04/Homio"
